...
4. **`POST /auth/solana/verify`** — `SolanaSessionsController#verify` (`app/controllers/solana_sessions_controller.rb:25-107`), routed as `solana_sessions#verify` (`config/routes.rb:192`).
