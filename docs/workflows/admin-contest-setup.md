...
- **Session token mismatch** — `ApplicationController#verify_session_token` (`app/controllers/application_controller.rb:455-475`) force-logs-out a stale session (OPSEC-045). Admin re-runs step 1.
