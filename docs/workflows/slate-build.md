...
| Caller | Where |
|---|---|
| Contest creation — `ContestsController#resolve_span_slate` | `app/controllers/contests_controller.rb:2302` |
...
- [[admin-contest-setup]] — the successor. `ContestsController#resolve_span_slate`
  (`app/controllers/contests_controller.rb:2276-2306`, step 7's real contest-creation path)
